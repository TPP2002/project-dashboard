export interface AuditionPreferences { volume: number; seed: number; blind: boolean }
export const DEFAULT_PREFERENCES: AuditionPreferences = { volume: 70, seed: 1, blind: false }
