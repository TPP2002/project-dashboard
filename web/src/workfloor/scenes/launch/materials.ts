...
<pattern id="pScreenLines" width="4" height="4" patternUnits="userSpaceOnUse"><path d="M0 .5H4" stroke="var(--launch-scene-light)" stroke-width="1" opacity=".065"/></pattern>
  ...
  <linearGradient id="gSky" x1="0" y1="0" x2="0" y2="1"><stop stop-color="var(--launch-deep)"/><stop offset=".65" stop-color="var(--launch-ocean)"/><stop offset="1" stop-color="var(--launch-horizon)"/></linearGradient>
  <linearGradient id="gSea" x1="0" y1="0" x2=".35" y2="1"><stop stop-color="var(--launch-horizon)"/><stop offset=".35" stop-color="var(--launch-ocean)"/><stop offset="1" stop-color="var(--launch-deep)"/></linearGradient>
